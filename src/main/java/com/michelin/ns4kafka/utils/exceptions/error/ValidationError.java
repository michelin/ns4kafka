...
public class ValidationError {
    ...
    public static String invalidQuotaNew(String invalidFieldName, String invalidFieldValue, String used) {
        return String.format(INVALID_FIELD, invalidFieldValue, invalidFieldName,
            String.format("quota already exceeded (%s/%s)", used, invalidFieldValue));
    }

    public static String invalidQuotaOperation(String quota, long used, long limit) {
