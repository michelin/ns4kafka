...
class ExceptionHandlerIntegrationTest extends KafkaIntegrationTest {
    ...
    void shouldThrowUnknownNamespaceForTopic() {
        HttpClientResponseException exception = assertThrows(HttpClientResponseException.class, () -> ns4KafkaClient
                .toBlocking()
                .exchange(HttpRequest.create(HttpMethod.GET, "/api/namespaces/ns2/topics")
                        .bearerAuth(token)));
    ...
    void shouldThrowUnauthorizedWhenNotAuthenticatedForTopic() {
        HttpClientResponseException exception = assertThrows(HttpClientResponseException.class, () -> ns4KafkaClient
                .toBlocking()
                .exchange(HttpRequest.create(HttpMethod.GET, "/api/namespaces/ns1/topics")));
    ...
    void shouldThrowNamespaceForbiddenWhenAccessingForbiddenNamespaceAsUser() {
        ...
        ns4KafkaClient
                .toBlocking()
                .exchange(HttpRequest.create(HttpMethod.POST, "/api/namespaces/userNs/role-bindings")
                        .bearerAuth(token)
                        .body(rb));
    ...
    void shouldThrowResourceForbiddenWhenAccessingForbiddenResourceAsUser() {
        ...
        HttpRequest<?> request =
                HttpRequest.create(HttpMethod.GET, "/api/namespaces/ns1/topics").bearerAuth(userToken);
    ...
    void shouldNotValidateUnknownHttpVerbForTopic() {
        HttpClientResponseException exception = assertThrows(HttpClientResponseException.class, () -> ns4KafkaClient
                .toBlocking()
                .exchange(HttpRequest.create(HttpMethod.PUT, "/api/namespaces/ns1/topics/")
                        .bearerAuth(token)));
